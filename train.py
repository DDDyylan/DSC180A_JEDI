...
MODEL_CLASSES = {
    'gpt2': GPT2ForLatentConnectorNew, # updated by yunhao, for 84 only
...
def main():
    ...
    if True:
        ...
        file_list = [current_file, 'src/modules/vae.py',args.shell_name]
    ...
    if args.use_pretrained_model:
        ...
        output_full_dir = os.path.join(args.checkpoint_dir, 'checkpoint-full-{}'.format(2)) # global step
        ...
        if args.ddpm_pretrain:
            ddpm_full_dir = os.path.join(args.checkpoint_dir, 'checkpoint-ddpm-2-1') #globl step
