...
echo $sym
ckpt='/data/yunhao/ckpts/Apr9_ftyelp_2gpu_128_b128_e50_b0.0_lr5e-5_w8' #Apr8_nopre_book_w5_128_b128_e5_b0.0_lr9e-5'  # book/Apr8_nopre_book_w5_128_b128_e5_b0.0_lr9e-5'  #/Mar21_4_new_w5_128_b128_e50_b0.0_lr5e-5   --master_port=29501 
...
CUDA_VISIBLE_DEVICES=1 python -m torch.distributed.launch --nproc_per_node=$num_gpu --master_port=29503 run_lm_joint_vae_training_pretraining_new_DDP.py \
